...
//        if(this.textCompleate.isBlank()){
//            this.status = MatchStatus.live;
//        }
//        else {
//            this.status = MatchStatus.COMPLETED;
//        }
        this.status = (textCompleate.isBlank()) ? MatchStatus.live : MatchStatus.COMPLETED ;
    }

    public Match(int matchId, String teamHeading, String matchNumberVenue, String battingTeam, String battingTeamScore, String bowlingTeam, String bowlingTeamScore, String liveText, String matchLink, String textCompleate, MatchStatus status) {
